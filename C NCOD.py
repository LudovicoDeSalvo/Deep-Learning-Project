...
class SoftCoTeaching:
    ...
    def train_epoch(self, data_loader, epoch):
        ...
        for batch_idx, data in enumerate(data_loader):
            ...
            output1, emb1 = self.model1(data)
            output2, emb2 = self.model2(data)
        ...
        # ✅ Correctly return after all batches
...
def train_with_soft_co_teaching(args, device, use_adaptive=False, checkpoint_path=None):
    ...
    if args.baseline_mode == 2:
        ...
        criterion = NCODLoss(num_classes=6, emb_dim=args.emb_dim)
    else:
        criterion = torch.nn.CrossEntropyLoss()
...
def get_arguments():
    ...
    args['train_path'] = "datasets/C/0.2_asy_train.json"
    args['test_path'] = "datasets/C/0.2_asy_test.json"
